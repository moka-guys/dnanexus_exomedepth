...
docker run -v /home/dnanexus:/home/dnanexus seglh/exomedepth:latest readCount.R /home/dnanexus/out/exomedepth_output/exomedepth_output/$bedfile_prefix/"$bedfile_prefix"_readCount.RData $reference_genome_path $bedfile_path $bam_list
...
docker run -v /home/dnanexus:/home/dnanexus seglh/exomedepth:latest exomeDepth.R 'v1.0.0' /home/dnanexus/out/exomedepth_output/exomedepth_output/$bedfile_prefix/"$samplename"_output.pdf $subpanel_bed_path:$bedfile_prefix /home/dnanexus/out/exomedepth_output/exomedepth_output/$bedfile_prefix/"$bedfile_prefix"_readCount.RData $bam:$samplename 
done
